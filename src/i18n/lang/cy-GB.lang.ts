...
export class Lang_cy_GB extends Lang_en_US {
	override NAME_DEFAULT = 'Welsh';
	override NAME_LOCAL = 'Cymraeg';

	override unknown_command = (): string => 'Gorchymyn anhysbys!';

	override ping_success = (delay: number): string => `Pong! Hwyrni: ${delay}ms`;

	override image_download_error_with_reason = (reason: Error): string => `Methu lawrlwyddio'r llun: \`${reason}\``;
	override image_invalid_name = 'Dydy yna ddim yn edrych fel enw cywir...';
	override image_invalid_url = 'Dydy yna ddim yn edrych fel URL cywir...';
	override image_invalid_domain =
		"Dydy'r llun yna ddim wedi'i cynnal ar wefan caniateir. Triwch uwchlwytho i Discord cyntaf!";
	override image_unknown_error = "Methu lawrlwythio'r llun. Digwyddodd gwall anhysbys.";
	...
	override embed_help_callout_title = 'Angen help?';
	override embed_remoji_author_name = 'Remoji - Rheolwr emoji Discord.';
	override embed_footer_tagline = 'Remoji - Rheolwr emoji Discord. - Wedi creu gan Shino';
	override embed_join_support_server_link = "Ymuno'r gweinydd cyfnogaeth!";
	override embed_vote_callout_link = 'Cliciwch yma i bleidleisio am Remoji!';

	override command_error_guild_only = ':x: Gall y gorchymyn hyn dim ond cael ei ddefnyddio yn gweinyddau.';
	...
	override emote_copy_invalid_emote =
	...
	override emote_copy_invalid_url = "Methu lawrlwythio'r emoji yna. Efallau ei wedi dileu?";
	...
	override emote_copy_unknown_download_error = "Digwyddodd gawll anhysbys tra'n lawrlwythio'r emoji yna.";
	override emote_copy_unknown_upload_error = "Digwyddodd gawll anhysbys tra'n uwchlwythio'r emoji yna i Discord.";
	override emote_copy_success = (name: string, newEmoji: string): string =>
		`:tada:  Wedi copio \`:${name}:\` i eich gweinydd! ${newEmoji}`;
	override emote_copy_no_emotes = 'Rhaid darparu un neu fwy emotes i gopio.';
	override emote_copy_multiple_success = (failed: number, success: number): string =>
		`Wedi lanlwythio ${success} emojis yn llwyddiannus! (Methu ${failed})`;

	override info_remoji_description =
	...
	override info_remoji_server_field =
		"Ymunwch â'r gweinydd cefnogaeth Remoji i gael y wybodaeth ddiweddaraf am nodweddion newydd!";
	override info_remoji_server_invite = (invite: string): string => `**[YMUNWCH â DISCORD REMOJI](${invite})**`;
	override info_remoji_bot_field = 'Gwahodd Remoji!';
	override info_remoji_bot_invite = (appId: string, permissionBits: string): string =>
		`**[GWAHODD](https://discord.com/oauth2/authorize?client_id=${appId}&permissions=${permissionBits}&scope=applications.commands%20bot)**`;
	override info_remoji_vote_field = 'Pleidleisiwch am Remoji!';
	override info_remoji_vote_value = (url: string): string => `**[PLEIDLEISIWCH AR TOP.GG](${url})**`;
	override info_remoji_created = 'Wedi creu gan Shino.';
	override info_remoji_version = (version: string, gitBranch: string, gitCommit: string): string =>
